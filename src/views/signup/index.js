        ...
        <section>
          ...
          <LazyLoad once>
            <div className="progressbar">
              <div className={pageStage===1 ? 'progress-step progress-step-active' : 'progress-step'} data-title="Signup"></div>
              <div className={pageStage===2 ? 'progress-step progress-step-active' : 'progress-step'} data-title="More Details"></div>
              <div className={pageStage===3 ? 'progress-step progress-step-active' : 'progress-step'} data-title="Completed"></div>
            </div>
          </LazyLoad>
              ...
              <LazyLoad once>
                <div className="wrap">
                  <FormUserCompleted 
                    ...
                    successMessage={'Profile details has been Succesfully Uploaded!'} // success message
                  />
                </div>
              </LazyLoad>
            }
